...
public class Main {
  ...
  //static String path = "http://ec2-34-222-221-189.us-west-2.compute.amazonaws.com:8080/Server_war/skiers";
...
//    System.out.println("Throughput: " + ((successCount.get() + failCount.get()) / ((double)time / 1000)));
  ...
  public static void writeCSV() {
    try {
      FileWriter csvWriter = new FileWriter("records_" + numThreads + ".csv");
