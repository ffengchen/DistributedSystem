...
public class Main {
  ...
  static String path = "http://ec2-54-218-109-78.us-west-2.compute.amazonaws.com:8080/Server_war/skiers";
  //static String path = "http://loadbalancera3-301949066.us-west-2.elb.amazonaws.com:8080/Server_war/skiers";
  //static String path;
...
//    System.out.println("Throughput: " + ((successCount.get() + failCount.get()) / ((double)time / 1000)));
  ...
  public static void writeCSV() {
    try {
      FileWriter csvWriter = new FileWriter("records_singleServer_persistent" + numThreads + ".csv");
